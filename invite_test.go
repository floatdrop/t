...
func TestParseInviteURL(t *testing.T) {
	tests := []struct {
		...
		url:   "t://localhost:4433/linktest",
		relay: "localhost:4433",
		room:  "linktest",
		ok:    true,
	}, {
		name:  "remote relay",
		url:   "t://relay.example.com:443/standup",
		...
		url:   "t://relay.example.com/r1?relay=https%3A%2F%2Frelay.example.com%2Flive",
		relay: "https://relay.example.com/live",
		room:  "r1",
		ok:    true,
	}, {
		name:  "moqt relay overrides the authority",
		url:   "t://relay.example.com:4433/r2?relay=moqt%3A%2F%2Frelay.example.com%3A4433%2Fapp",
